...
const DEMO_ACTIVE_CALLS: ActiveCall[] = [
  ...
  },
  {
    ...
    agentId: 'Sherzod A.',
    customerPhone: '+998 90 ••• 34 7•',
    customerRegion: 'Namangan',
    duration: 213,
    sentiment: 'positive',
    topObjection: null,
    startedAt: new Date(now - 213_000).toISOString(),
    active: true,
    isHero: false,
  },
  {
    ...
    agentId: 'Mavluda K.',
    customerPhone: '+998 94 ••• 56 1•',
    customerRegion: 'Buxoro',
    duration: 88,
    sentiment: 'negative',
    topObjection: 'Hujjatlar yetarli emas',
    startedAt: new Date(now - 88_000).toISOString(),
    active: true,
    isHero: false,
  },
  {
    ...
    agentId: 'Diyora S.',
    customerPhone: '+998 97 ••• 22 8•',
    customerRegion: 'Andijon',
    duration: 54,
    sentiment: 'neutral',
    topObjection: "To'lov muddati noqulay",
    startedAt: new Date(now - 54_000).toISOString(),
    active: true,
    isHero: false,
  },
]
...
const DEMO_HISTORY: CallHistoryItem[] = [
  { id: 'h-1',  customerName: 'Bekzod Karimov',      agentId: 'Diyora S.',   duration: 312, sentiment: 'positive', outcome: 'completed',   complianceScore: 92, startedAt: new Date(now - 1_800_000).toISOString(),  endedAt: null },
  { id: 'h-2',  customerName: 'Sarvar Mirzayev',      agentId: 'Jasur T.',    duration: 184, sentiment: 'neutral',  outcome: 'completed',   complianceScore: 75, startedAt: new Date(now - 3_600_000).toISOString(),  endedAt: null },
  { id: 'h-3',  customerName: 'Zulfiya Rahimova',     agentId: 'Nilufar R.',  duration: 98,  sentiment: 'negative', outcome: 'failed',      complianceScore: 41, startedAt: new Date(now - 5_400_000).toISOString(),  endedAt: null },
  { id: 'h-4',  customerName: 'Odil Hasanov',         agentId: 'Diyora S.',   duration: 256, sentiment: 'positive', outcome: 'transferred', complianceScore: 88, startedAt: new Date(now - 7_200_000).toISOString(),  endedAt: null },
  { id: 'h-5',  customerName: 'Gulnora Saidova',      agentId: 'Jasur T.',    duration: 421, sentiment: 'positive', outcome: 'completed',   complianceScore: 96, startedAt: new Date(now - 9_000_000).toISOString(),  endedAt: null },
  { id: 'h-6',  customerName: 'Rustam Nazarov',       agentId: 'Sherzod A.',  duration: 145, sentiment: 'neutral',  outcome: 'completed',   complianceScore: 82, startedAt: new Date(now - 10_800_000).toISOString(), endedAt: null },
  { id: 'h-7',  customerName: 'Dilorom Yuldasheva',   agentId: 'Mavluda K.',  duration: 456, sentiment: 'positive', outcome: 'completed',   complianceScore: 98, startedAt: new Date(now - 12_600_000).toISOString(), endedAt: null },
  { id: 'h-8',  customerName: 'Behruz Qodirov',       agentId: 'Diyora S.',   duration: 389, sentiment: 'positive', outcome: 'completed',   complianceScore: 94, startedAt: new Date(now - 14_400_000).toISOString(), endedAt: null },
  { id: 'h-9',  customerName: 'Nilufar Xasanova',     agentId: 'Jasur T.',    duration: 223, sentiment: 'neutral',  outcome: 'transferred', complianceScore: 71, startedAt: new Date(now - 16_200_000).toISOString(), endedAt: null },
  { id: 'h-10', customerName: 'Alisher Rahimov',      agentId: 'Sherzod A.',  duration: 78,  sentiment: 'negative', outcome: 'failed',      complianceScore: 28, startedAt: new Date(now - 18_000_000).toISOString(), endedAt: null },
  { id: 'h-11', customerName: 'Bobur Ismoilov',       agentId: 'Diyora S.',   duration: 134, sentiment: 'neutral',  outcome: 'completed',   complianceScore: 79, startedAt: new Date(now - 21_600_000).toISOString(), endedAt: null },
  { id: 'h-12', customerName: 'Feruza Normatova',     agentId: 'Nilufar R.',  duration: 201, sentiment: 'positive', outcome: 'completed',   complianceScore: 87, startedAt: new Date(now - 25_200_000).toISOString(), endedAt: null },
  { id: 'h-13', customerName: 'Ulugbek Kamolov',      agentId: 'Jasur T.',    duration: 55,  sentiment: 'negative', outcome: 'failed',      complianceScore: 22, startedAt: new Date(now - 28_800_000).toISOString(), endedAt: null },
  { id: 'h-14', customerName: 'Kamola Abdullayeva',   agentId: 'Mavluda K.',  duration: 312, sentiment: 'positive', outcome: 'completed',   complianceScore: 91, startedAt: new Date(now - 32_400_000).toISOString(), endedAt: null },
  { id: 'h-15', customerName: 'Jahongir Toshpulatov', agentId: 'Sherzod A.',  duration: 167, sentiment: 'neutral',  outcome: 'transferred', complianceScore: 65, startedAt: new Date(now - 36_000_000).toISOString(), endedAt: null },
]

type TranscriptEntry = { id: string; speaker: string; text: string; ts: number }
const DEMO_TRANSCRIPTS: Record<string, TranscriptEntry[]> = {
  'demo-1': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Diyora murojaat qilyapman. Xizmatdan qanday foydalanishim mumkin?", ts: 4 },
  ...
  'demo-2': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum, Raqamli bank. Jasur murojaat qilyapman.", ts: 3 },
  ...
  'demo-3': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Nilufar.", ts: 3 },
  ...
  'h-1': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Diyora.", ts: 3 },
  ...
  'h-2': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum, Raqamli bank. Jasur.", ts: 2 },
  ...
  'h-5': [
    ...
    { id: 't5', speaker: 'agent',    text: "Ha, Raqamli Bank Mobile ilovasi orqali 5 daqiqada ochishingiz mumkin.", ts: 32 },
  ...
  'demo-4': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Sherzod murojaat qilyapman.", ts: 3 },
    { id: 't2', speaker: 'customer', text: "Salom. Uy-joy krediti olmoqchi edim, shartlarini bilmoqchi edim.", ts: 10 },
    { id: 't3', speaker: 'agent',    text: "Marhamat. Qancha summa va qancha muddatga mo'ljallayapsiz?", ts: 18 },
    { id: 't4', speaker: 'customer', text: "300 million so'm, 15 yilga.", ts: 25 },
    { id: 't5', speaker: 'agent',    text: "Yillik 19%, boshlang'ich to'lov 15%. Chegirma dasturimiz ham bor.", ts: 33 },
    { id: 't6', speaker: 'customer', text: "Chegirma dasturi nima?", ts: 41 },
    { id: 't7', speaker: 'agent',    text: "Agar oylik maosh Raqamli Bank kartasiga tushsa, foiz 17%gacha tushadi.", ts: 49 },
  ],
  'demo-5': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Mavluda.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Kredit arizam uchun hujjat topshirdim, lekin rad etildi.", ts: 9 },
    { id: 't3', speaker: 'agent',    text: "Kechirasiz. Qaysi hujjat yetishmasligi mumkinligini tekshirib ko'raman.", ts: 17 },
    { id: 't4', speaker: 'customer', text: "Daromad sertifikatim bor edi-ku.", ts: 24 },
    { id: 't5', speaker: 'agent',    text: "Tizimda ko'rishim bo'yicha ish joyingizdan 6 oylik ma'lumotnoma zarur ekan.", ts: 32 },
  ],
  'demo-6': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Diyora.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Avtokredit bo'yicha qiziqmoqchi edim.", ts: 8 },
    { id: 't3', speaker: 'agent',    text: "Albatta. Qanday avtomobil va qancha muddatga?", ts: 15 },
    { id: 't4', speaker: 'customer', text: "Chevrolet Tracker, 3 yilga. Oylik to'lov qancha bo'ladi?", ts: 24 },
    { id: 't5', speaker: 'agent',    text: "Taxminiy narx 350 million bo'lsa, oylik to'lov 9.8 million atrofida.", ts: 33 },
    { id: 't6', speaker: 'customer', text: "Birozdan ko'p. To'lov muddatini uzaytirsa bo'ladimi?", ts: 42 },
  ],
  'h-6': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Sherzod.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Pul o'tkazmasi bo'yicha komissiya qancha?", ts: 8 },
    { id: 't3', speaker: 'agent',    text: "Ichki o'tkazmalar bepul. Boshqa banklarga 0.5%, minimum 2 000 so'm.", ts: 16 },
    { id: 't4', speaker: 'customer', text: "Tushunarliq. Rahmat.", ts: 23 },
    { id: 't5', speaker: 'agent',    text: "Boshqa savollar bo'lsa qo'ng'iroq qiling. Yaxshi kun!", ts: 29 },
  ],
  'h-7': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Mavluda.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Depozitim muddati tugadi, pul qaerda?", ts: 8 },
    { id: 't3', speaker: 'agent',    text: "Tekshirib ko'raman. Karta raqamingizni ayta olasizmi?", ts: 15 },
    { id: 't4', speaker: 'customer', text: "Raqam yodimda yo'q, pasport bilan kelsam bo'ladimi?", ts: 24 },
    { id: 't5', speaker: 'agent',    text: "Ha, filialga tashrif buyuring, hamma masalani hal qilamiz.", ts: 31 },
    { id: 't6', speaker: 'customer', text: "Yaxshi, rahmat yo'q bunaqa xizmatga!", ts: 39 },
  ],
  'h-8': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Diyora.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Premium Plus kartasini olmoqchi edim.", ts: 8 },
    { id: 't3', speaker: 'agent',    text: "Albatta! Yillik limit 50 million, cashback 5%, lounge kirish.", ts: 16 },
    { id: 't4', speaker: 'customer', text: "Yillik to'lov bormi?", ts: 23 },
    { id: 't5', speaker: 'agent',    text: "Bu oy aksiya — yillik to'lov bekor qilingan.", ts: 29 },
    { id: 't6', speaker: 'customer', text: "Zo'r! Pasport ma'lumotlarimni aytay.", ts: 36 },
    { id: 't7', speaker: 'agent',    text: "Marhamat, aytishingiz mumkin.", ts: 41 },
    { id: 't8', speaker: 'customer', text: "AB 7654321, Toshkent viloyati.", ts: 48 },
    { id: 't9', speaker: 'agent',    text: "Qabul qildim. Ariza linkini SMS orqali yuboraman.", ts: 55 },
  ],
  'h-9': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Jasur.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Biznes kredit olish mumkinmi?", ts: 8 },
    { id: 't3', speaker: 'agent',    text: "Ha, biznes kreditlar bo'yicha mutaxassisimiz bor. Bog'laymiz.", ts: 15 },
    { id: 't4', speaker: 'customer', text: "Qachon bog'lanadi?", ts: 22 },
    { id: 't5', speaker: 'agent',    text: "1 ish kuni ichida. Telefon raqamingizni tasdiqlang.", ts: 28 },
  ],
  'h-10': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Sherzod.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Kartam bloklanib qoldi, nima qilay?", ts: 7 },
    { id: 't3', speaker: 'agent',    text: "Tekshiraman. 3 marta noto'g'ri PIN kiritilgan. Filialga boring.", ts: 15 },
    { id: 't4', speaker: 'customer', text: "Filial uzoqda, onlayn hal qilib bo'lmaydi?", ts: 23 },
    { id: 't5', speaker: 'agent',    text: "Xavfsizlik sababli faqat filialda. Kechirasiz.", ts: 30 },
    { id: 't6', speaker: 'customer', text: "Bu juda noqulay!", ts: 36 },
  ],
  'h-11': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Diyora.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Zaxira fondga pul o'tkazmoqchi edim.", ts: 9 },
    { id: 't3', speaker: 'agent',    text: "Qaysi summa va qaysi hisob?", ts: 15 },
    { id: 't4', speaker: 'customer', text: "500 000 so'm, joriy hisobdan.", ts: 22 },
    { id: 't5', speaker: 'agent',    text: "O'tkazma amalga oshirildi. SMS xabar keladi.", ts: 29 },
    { id: 't6', speaker: 'customer', text: "Rahmat, tez hal qildingiz.", ts: 35 },
  ],
  'h-12': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Nilufar.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Kredit qoldig'imni bilib olsam bo'ladimi?", ts: 9 },
    { id: 't3', speaker: 'agent',    text: "Albatta. Pasport raqamingizni ayta olasizmi?", ts: 15 },
    { id: 't4', speaker: 'customer', text: "AA 3456789.", ts: 21 },
    { id: 't5', speaker: 'agent',    text: "Qolgan summa 12 400 000 so'm, muddat 18 oy.", ts: 28 },
    { id: 't6', speaker: 'customer', text: "Muddatdan oldin to'lashim mumkinmi?", ts: 35 },
    { id: 't7', speaker: 'agent',    text: "Ha, jarimasisiz. Istalgan vaqtda.", ts: 41 },
    { id: 't8', speaker: 'customer', text: "Juda yaxshi, rahmat!", ts: 47 },
  ],
  'h-13': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Jasur.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Kredit olmoqchi edim, lekin oylik daromadim etarlimikin?", ts: 9 },
    { id: 't3', speaker: 'agent',    text: "Qancha summa va oylik daromadingiz qancha?", ts: 16 },
    { id: 't4', speaker: 'customer', text: "5 million kredit, 3 million daromad.", ts: 23 },
    { id: 't5', speaker: 'agent',    text: "Tizimni tekshirdim — daromad nisbati talabga javob bermayapti. Afsuski rad etiladi.", ts: 32 },
    { id: 't6', speaker: 'customer', text: "Boshqa yo'l yo'qmi?", ts: 39 },
  ],
  'h-14': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Mavluda.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Ota-onam uchun pensiya hisobi ochmoqchi edim.", ts: 9 },
    { id: 't3', speaker: 'agent',    text: "Marhamat. Ota-onangiz shaxsan kelishlari kerak, lekin hujjatlarni siz olib kelishingiz mumkin.", ts: 18 },
    { id: 't4', speaker: 'customer', text: "Qanday hujjatlar?", ts: 25 },
    { id: 't5', speaker: 'agent',    text: "Pasport, pensiya guvohnomasi va 2 ta 3x4 fotosurat.", ts: 32 },
    { id: 't6', speaker: 'customer', text: "Tushunarliq. Erta boramiz.", ts: 38 },
    { id: 't7', speaker: 'agent',    text: "Marhamat! Istalgan filialdayiz, yaxshi kun tilayman.", ts: 44 },
  ],
  'h-15': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! Raqamli bank, Sherzod.", ts: 2 },
    { id: 't2', speaker: 'customer', text: "Salom. Korporativ kredit bo'yicha maslahat kerak.", ts: 9 },
    { id: 't3', speaker: 'agent',    text: "Korporativ bo'limga yo'naltiraman, ular to'liq yordam beradi.", ts: 17 },
    { id: 't4', speaker: 'customer', text: "Necha kunda bog'lanadi?", ts: 24 },
    { id: 't5', speaker: 'agent',    text: "2 ish kunida. Email manzilingizni qoldirsangiz, tezroq bo'ladi.", ts: 31 },
    { id: 't6', speaker: 'customer', text: "Yaxshi, kutaman.", ts: 37 },
  ],
}
