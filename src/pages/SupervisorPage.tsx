...
const DEMO_TRANSCRIPTS: Record<string, TranscriptEntry[]> = {
  ...
  'demo-4': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! SQB bank, Sherzod murojaat qilyapman.", ts: 3 },
    ...
    { id: 't7', speaker: 'agent',    text: "Agar oylik maosh SQB kartasiga tushsa, foiz 17%gacha tushadi.", ts: 49 },
  ],
  'demo-5': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! SQB bank, Mavluda.", ts: 2 },
  ...
  'demo-6': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! SQB bank, Diyora.", ts: 2 },
  ...
  'h-6': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! SQB bank, Sherzod.", ts: 2 },
  ...
  'h-12': [
    { id: 't1', speaker: 'agent',    text: "Assalomu alaykum! SQB bank, Nilufar.", ts: 2 },
